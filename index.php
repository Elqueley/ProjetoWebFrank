        ...
        <div class="row">
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="2000">
                            <img src="./arquivos/imagens/ifms1.png" class="d-block w-100" alt="Imagens do IFMS">
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="./arquivos/imagens/ifms2.jpeg" class="d-block w-100" alt="Imagens do IFMS">
                        </div>
                        <div class="carousel-item">
                            <img src="./arquivos/imagens/ifms3.jpeg" class="d-block w-100" alt="Imagens do IFMS">
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Pedido de ajuda !</h5>
                        <p class="card-text">A única diferença entre cachorro e universitário, e que as pessoas tem 
                        pena do cachorro</p>
                        <a href="#" class="btn btn-primary">Click para ajudar um estudante</a>
                    </div>
                </div>
            </div>
        </div>
